...
static FLASH_DECLARE(const uint8_t const phy_pib_size[]) =
{
...
static FLASH_DECLARE(const uint8_t const mac_pib_size[]) =
{
...
static FLASH_DECLARE(const uint8_t const mac_sec_pib_size[]) =
{
...
static FLASH_DECLARE(const uint8_t const private_pib_size[]) =
{
