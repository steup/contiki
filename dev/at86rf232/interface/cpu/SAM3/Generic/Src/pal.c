...
static void pal_pio_setinput(Pio *pio, uint32_t mask, uint8_t attribute)
{
    ...
    {
        pio->PIO_IFSCER = mask; //pio->PIO_DIFSR = mask;
    }
 ...
 */
void PIOA_Handler(void) // void PIOA_IrqHandler(void)
{
 ...
 */
void PIOB_Handler(void) // void PIOB_IrqHandler(void)
{
 ...
 */
void PIOC_Handler(void) // void PIOC_IrqHandler(void)
{
